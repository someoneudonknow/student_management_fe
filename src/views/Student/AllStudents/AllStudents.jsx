import { Box, Button, IconButton, Stack, Table, Toolbar } from "@mui/material"
...
const AllStudents = () => {
  ...
  return (
    <Box p={1} component="div" sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <PrimaryTable wrapperSx={{ flex: 1 }} rows={rows} columns={STUDENT_INFO_COLUMNS} title="Thông tin học sinh" autoPageSizeOnMount />
    </Box>
  )
}
